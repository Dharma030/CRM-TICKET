...
const { deleteJWT } = require("../helpers/mongo.helper");
...
router.post("/login", async (req, res) => {
    ...
    if (!user.isVerified) {
		return res.json({
			status: "error",
			message: "Your account has not been verified. Please check your email and verify your account before being able to login!",
		});
	}
